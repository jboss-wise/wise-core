...
/**
 * This class was generated by Apache CXF 2.7.3-SNAPSHOT (1439267) 2013-02-20T16:44:23.123+01:00 Generated source version:
 * 2.7.3-SNAPSHOT
 *
 */
...
public interface Registration {
    ...
    public long register(
            @WebParam(name = "Customer", targetNamespace = "http://types.complex.jaxws.ws.test.jboss.org/") org.jboss.wise.test.integration.complex.Customer customer,
            @WebParam(name = "When", targetNamespace = "http://types.complex.jaxws.ws.test.jboss.org/") java.lang.Object when)
    ...
    public void echo(
            @WebParam(mode = WebParam.Mode.INOUT, name = "Customer", targetNamespace = "http://types.complex.jaxws.ws.test.jboss.org/") javax.xml.ws.Holder<Customer> customer);
    ...
    public boolean registerForInvoice(
            @WebParam(name = "InvoiceCustomer", targetNamespace = "http://types.complex.jaxws.ws.test.jboss.org/") org.jboss.wise.test.integration.complex.InvoiceCustomer invoiceCustomer)
            throws ValidationFault_Exception, AlreadyRegisteredFault_Exception;
    ...
    public java.util.List<java.lang.Long> bulkRegister(
            @WebParam(name = "Customers", targetNamespace = "http://types.complex.jaxws.ws.test.jboss.org/") java.util.List<org.jboss.wise.test.integration.complex.Customer> customers,
            @WebParam(name = "When", targetNamespace = "http://types.complex.jaxws.ws.test.jboss.org/") java.lang.Object when)
            throws ValidationFault_Exception, AlreadyRegisteredFault_Exception;
}
