...
public class ElementTest {
    ...
    public void shouldBuildTreeOfNumberElement() throws Exception {
        ...
        shouldBuildTreeOfNumberElement(Double.class, "myDouble", "87532478.48", "0.0", new Double(87532478.48), new Double(
                "0.0"));
        shouldBuildTreeOfNumberElement(BigDecimal.class, "myBigDecimal", "87532478.48", "0.0", new BigDecimal("87532478.48"),
                new BigDecimal("0.0"));
        shouldBuildTreeOfNumberElement(BigInteger.class, "myBigInteger", "87532478", "0", new BigInteger("87532478"),
                new BigInteger("0"));
    }
    ...
    public void shouldBuildTreeOfDurationElement() throws Exception {
        ...
        final String value = String.valueOf(DatatypeFactory.newInstance().newDuration(longVal)
    ...
    private static <T> void shouldBuildTreeOfNumberElement(Class<T> clazz, String name, String value, String expDefValue,
            T expObj, T expDefObj) throws Exception {
        ElementBuilder builder = getElementBuilder(true, false);
    ...
    private static <T> void shouldBuildTreeOfPrimitiveNumberElement(Class<T> clazz, String name, String value,
            String expDefValue, T expObj, T expDefObj) throws Exception {
        ElementBuilder builder = getElementBuilder(true, false);
        Element el = builder.buildTree(clazz, name, null, true);
        assertElementProps(el, true, false, false, false, false, false, false, 0);
        assertEquals(clazz, el.getClassType());
    ...
    private static void assertElementProps(Element el, boolean leaf, boolean group, boolean lazy, boolean nil,
            boolean nillable, boolean removable, boolean resolved, int childrenCount) {
        assertNotNull(el);
